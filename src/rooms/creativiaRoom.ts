...
export class CreativiaRoom extends Room<RoomState> {
  ...
  private pushObject = (object: Objects) => {
  ...
  onCreate(options: any) {
    ...
    this.onMessage("OBJECT_PLACED", (client, input) => {
      // Add object to the state and broadcast to all clients
      console.log("OBJECT_PLACED", input);

      this.pushObject(input);

      this.broadcast("OBJECT_PLACED", input);
    });
